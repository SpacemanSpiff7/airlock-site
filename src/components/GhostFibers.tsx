/*
 * Adapted from React Bits: Ghost Fibers by David Haz.
 * Original: https://reactbits.dev/backgrounds/ghost-fibers
...
void main() {
  ...
  vec3 backdrop = mix(vec3(0.0, 0.098039, 0.203922), vec3(1.0), step(0.5, uLightMode));
